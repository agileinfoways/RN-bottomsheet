...
export const GM = {
  ...
  getStatusBarHeight() {
    if(CONST.DEVICE_OS == "ios") {
      // return (isIPhoneX) ?  44 : 20
      return (GM.isIphoneX()) ? 58 : 0
    } else if(CONST.DEVICE_OS == "android") {
  ...
  isIphoneX() {
    ...
    if (CONST.DEVICE_OS === 'ios') {
      isIPhoneX = CONST.DEVICE_WIDTH === X_WIDTH && CONST.DEVICE_HEIGHT === X_HEIGHT || CONST.DEVICE_WIDTH  === XSMAX_WIDTH && CONST.DEVICE_HEIGHT === XSMAX_HEIGHT;
    }
    GM.showLog('IS IPHONE X HEIGHT ==> ' + isIPhoneX)
    return isIPhoneX;
  }
};